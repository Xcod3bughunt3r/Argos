...
mkdir ~/Documents/scripts && cp ~/Downloads/Argos/* ~/Documents/scripts
sudo chmod +x ~/Documents/scripts/*

mkdir ~/Pictures/icons && cp ~/Downloads/Argos/banner.jpg ~/Pictures/icons

# moving update_osint_tools.sh in the programs directory
mkdir -p ~/Downloads/Programs && cp ~/Downloads/Argos/* ~/Downloads/Programs/

# setting the 'quiet priest' background image
cp ~/Downloads/Argos/banner.jpg && ~/Documents/scripts/background.sh
echo -e "$OKGREEN +----=[DOOONE!!!]=----+ $RESET"
echo "    "
